...
namespace _3D_Knots
{
    ...
    //A3 = 2
    //====================================================================
    class Knot6Geometry : GLGeometry
    {
        ...
        // Knot parameters
        public double a1 = 2.0;
        public double a2 = 2.0;
        public double a3 = 2.0;
        ...
        public Knot6Geometry(double size, int steps, double diameter, int slices)
        {
            my_Size = size;
            my_Steps = steps;
