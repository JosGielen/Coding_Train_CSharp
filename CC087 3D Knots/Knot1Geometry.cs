...
namespace _3D_Knots
{
    //x = A1 * cos(A2 * mu) + A3 * cos(A4 * mu) + A5 * cos(A6 * mu) + A7 * cos(A8 * mu)
    //y = B1 * sin(B2 * mu) + B3 * sin(B4 * mu)
    //z = C1 * sin(C2 * mu) * C3 * sin(C4 * mu) + C5 * sin(C6 * mu) + C7 * sin(C8 * mu)
    ...
    //A8 = 4                 C8 = 6
    //====================================================================
    class Knot1Geometry : GLGeometry 
    {
        ...
        // Knot parameters
        public double a1 = 10.0;
        public double a2 = 1.0;
        public double a3 = 10.0; 
        public double a4 = 3.0;
        public double a5 = 1.0;
        public double a6 = 2.0;
        public double a7 = 1.0;
        public double a8 = 4.0;
        public double b1 = 6.0;
        public double b2 = 1.0;
        public double b3 = 10.0;
        public double b4 = 3.0;
        public double b5 = 0.0;
        public double b6 = 0.0;
        public double b7 = 0.0;
        public double b8 = 0.0;
        public double c1 = 4.0;
        public double c2 = 3.0;
        public double c3 = 1.0;
        public double c4 = 2.5;
        public double c5 = 4.0;
        public double c6 = 4.0;
        public double c7 = -2.0;
        public double c8 = 6.0;

        public Knot1Geometry(double size, int steps, double diameter, int slices)
        {
            my_Size = size;
            my_Steps = steps;
        ...
        public override void CreateVertices()
        {
            ...
            for (int I = 0; I <= my_Steps; I++)
            {
                ...
                x = my_Size * (a1 * Math.Cos(a2 * mu) + a3 * Math.Cos(a4 * mu) + a5 * Math.Cos(a6 * mu) + a7 * Math.Cos(a8 * mu));
                y = my_Size * (b1 * Math.Sin(b2 * mu) + b3 * Math.Sin(b4 * mu));
                z = my_Size * (c1 * Math.Sin(c2 * mu) * c3 * Math.Sin(c4 * mu) + c5 * Math.Sin(c6 * mu) + c7 * Math.Sin(c8 * mu));
