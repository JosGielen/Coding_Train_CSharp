...
namespace _3D_Knots
{
    ...
    //a1 = 0.72   b1 = 4.0    c1 = 0.2*PI
    //a2 = 6.0                c2 = 6.0
    //a3 = 0.5*PI
    //====================================================================
    class Knot5Geometry : GLGeometry
    {
        ...
        public double c1 = 0.2 * Math.PI;
        public double c2 = 6.0;
        ...
        public Knot5Geometry(double size, int steps, double diameter, int slices)
        {
            my_Size = size;
            my_Steps = steps;
