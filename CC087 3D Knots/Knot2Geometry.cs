...
namespace _3D_Knots
{
    //x = A1 * cos(A2 * mu + A3) + A4 * cos(A5 * mu)
    //y = B1 * sin(B2 * mu) + B3 * sin(B4 * mu)
    //z = C1 * sin(C2 * mu) + C3 * sin(C4 * mu) 
    ...
    //A5 = 3     
    //====================================================================
    class Knot2Geometry : GLGeometry
    {
        ...
        // Knot parameters
        public double a1 = 4.0 / 3.0;
        public double a2 = 1.0;
        public double a3 = Math.PI;
        public double a4 = 2.0;
        public double a5 = 3.0;
        public double a6 = 0.0;
        public double a7 = 0.0;
        public double a8 = 0.0;
        public double b1 = 4.0 / 3.0;
        public double b2 = 1.0;
        public double b3 = 2.0;
        ...
        public double c2 = 4.0;
        public double c3 = 0.5;
        public double c4 = 2.0;
        public double c5 = 0.0;
        public double c6 = 0.0;
        public double c7 = 0.0;
        public double c8 = 0.0;

        public Knot2Geometry(double size, int steps, double diameter, int slices)
        {
            my_Size = size;
            my_Steps = steps;
        ...
        public override void CreateVertices()
        {
            ...
            for (int I = 0; I <= my_Steps; I++)
            {
                ...
                x = my_Size * (a1 * Math.Cos(a2 * mu + a3) + a4 * Math.Cos(a5 * mu));
                y = my_Size * (b1 * Math.Sin(b2 * mu) + b3 * Math.Sin(b4 * mu));
                z = my_Size * (c1 * Math.Sin(c2 * mu) + c3 * Math.Sin(c4 * mu));
