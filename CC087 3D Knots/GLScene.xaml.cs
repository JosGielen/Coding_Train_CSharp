    ...
    public partial class GLScene : UserControl
    {
        ...
        private void LoadDefaultShaders()
        {
            try
            {
                ...
                StreamReader reader = new StreamReader(assembly.GetManifestResourceStream("_3D_Knots.PerPixel.vert"));
                my_VertexShader = reader.ReadToEnd();
                reader.Close();
                reader = new StreamReader(assembly.GetManifestResourceStream("_3D_Knots.PerPixel.frag"));
