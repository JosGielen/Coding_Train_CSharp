...
namespace JG_Matrix
{
    public class Matrix : ICloneable 
    {
        ...
        /// <summary>
        /// Create a Matrix from a single line string (format= [[x,x,x,...][x,x,x,...]...])
        /// </summary>
        /// <param name="s">a single line string (format= [[x,x,x,...][x,x,x,...]...])</param>
        public static Matrix FromString(string s)
        {
            ...
            try
            {
                ...
                {
                    throw new Exception("FromString: The string has an invalid format.\n" + "Correct Format = [[x,x,x,..][x,x,x,...]....]");
                }
            }
        ...
        /// <summary>
        /// Returns a multi line string description of a Matrix (format= [[x , x , x , ...]\n [x , x , x , ...]\n...])
        /// </summary>
        ...
        /// <summary>
        /// Returns a single line string description of a Matrix (format= [[x,x,x,...][x,x,x,...]...])
        /// </summary>
