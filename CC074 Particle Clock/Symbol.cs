...
namespace Particle_Clock
{
    internal class Symbol : Shape
    {
        ...
        private void Update()
        {
            ...
            ftext = new FormattedText(my_Text, CultureInfo.GetCultureInfo("en-us"), FlowDirection.LeftToRight, face, my_FontSize * 96.0 / 72.0, Fill, VisualTreeHelper.GetDpi(this).PixelsPerDip);
